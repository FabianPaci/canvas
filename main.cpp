...
int main(int, char**)
{
    ...
    ImVec4 color_picker = ImVec4(0.45f, 0.55f, 0.60f, 1.00f);
    ...
    while (!done)
    {
        ...
        glClearColor(color_picker.x * color_picker.w, color_picker.y * color_picker.w, color_picker.z * color_picker.w, color_picker.w);
